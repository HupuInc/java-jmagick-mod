...
/**
    ...
    /**
     * Searches the list of image artifacts and returns
     *  the value of the artifact if it exists otherwise null.
     *
     * @param key the key of the artifact
     * @return the value of the artifact if exists, otherwise, null.
     * @exception MagickException on error
     */
    public native String getImageArtifact(String key)
    throws MagickException;

    /**
     * Searches the list of image artifacts and replaces the
     * artifact value.  If it is not found in the list, the artifact name
     * and value is added to the list. setImageArtifact returns True if the
     * attribute is successfully replaced or added to the list, otherwise
     * False. If the value is null, the matching key is deleted from the list.
     *
     * @param key the key of the artifact
     * @param value the value of the artifact
     * @return true if the artifact is replace or false if added
     * @exception MagickException on error
     */
    public native boolean setImageArtifact(String key, String value)
    throws MagickException;
