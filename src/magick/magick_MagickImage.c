 ...
 * Signature: (Ljava/lang/String;)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_magick_MagickImage_getImageArtifact
    (JNIEnv *env, jobject self, jstring key)
{
    Image *image;
    const char *iKey;
    ...
    iKey = (*env)->GetStringUTFChars(env, key, 0);
    iValue = GetImageArtifact(image, iKey);
    (*env)->ReleaseStringUTFChars(env, key, iKey);
    ...
    return (*env)->NewStringUTF(env, iValue);
}
 ...
 * Signature: (Ljava/lang/String;Ljava/lang/String;)Z
 */
JNIEXPORT jboolean JNICALL Java_magick_MagickImage_setImageArtifact
    (JNIEnv *env, jobject self, jstring key, jstring value)
{
    Image *image;
    const char *iKey, *iValue;
    ...
    iKey = (*env)->GetStringUTFChars(env, key, 0);
    iValue = (value == NULL) ? NULL : (*env)->GetStringUTFChars(env, value, 0);
    result = SetImageArtifact(image, iKey, iValue);
    if (iValue != NULL) {
    (*env)->ReleaseStringUTFChars(env, value, iValue);
    }
    (*env)->ReleaseStringUTFChars(env, key, iKey);
